...
class AdjacentDepartments
{
    ...
    /** @return string[] **/
    public function find(string $department): array
    {
        if (false === \array_key_exists($department, static::DEPARTMENTS)) {
            throw new AdjacentDepartmentsNotFoundException($department);
        }

        return static::DEPARTMENTS[$department];
    }

    public function isAdjacent(string $department, string $adjacent): bool
    {
        return \in_array(
            $adjacent,
